        ...
        <div class="atas">
            <div class="row">
                ...
                <div class="col-sm-10 pt-3" style="background-color:transparent;">
                  <img class="logokecil" src="logoputih.png" alt="">
                  <button class="buttonlogin float-right" data-toggle="modal" data-target="#modalRegisterForm" >login</button> 
                </div>
                <div class="col-sm-1""></div>
            </div>
          </div>
                ...
                <div class="col pt-3" id="tabrak2">
                    <button type="button" class="btn btn-lg" id="btnemail">
                        <div style="display: flex;">
                            <div class="bicon">
                                <img class="bicon" src="iconmail.png">
                            </div>
                    ...
                    <button type="button" class="btn btn-lg" id="btnfb">
                        <div style="display: flex;">
                            <div class="bicon">
                                <img class="bicon" src="iconfbwhite.png">
                            </div>
                            <div class="bitext px-3">
                    ...
                    <button type="button" class="btn btn-lg" id="btngoogle">
                        <div style="display: flex;">
                            <div class="bicon">
                                <img class="bicon" src="icongoogle.png">
                            </div>
                    ...
                    <button type="button" class="btn btn-lg" id="btntanya">
                        <div style="display: flex;">
                            <div class="bicon">
                                <img class="bicon" src="icontanya.png"">
                            </div>
                            <div class="bitext px-3">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-sm-8" style="background-color:rgb(255, 255, 255);">
                <div class="card-deck">
                    ...
                    <div class="card">
                        <div class ="overlay2">
                            <img class="card-img-top" src="card4.jpg" alt="Card image cap">
                        </div>
                    </div>
                    <div class="card">
                        <div class ="overlay2">
                            <img class="card-img-top" src="card5.jpg" alt="Card image cap">
                        </div>
                    </div>
                </div>
            </div>
          ...
          <div class="col-sm-1" style="background-color:#ffff;"></div>
            <div class="col-sm-8" style="background-color:rgb(255, 255, 255);">
                <div class="card-deck">
                    <div class="card">
                        <div class ="overlay2">
                            <img class="card-img-top" src="card6.jpg" alt="Card image cap">
                        </div>
                    </div>
                    <div class="card">
                        <div class ="overlay2">
                    ...
                    <div class="card">
                        <div class ="overlay2">
                            <img class="card-img-top" src="card8.jpg" alt="Card image cap">
                        </div>
                    </div>
                    <div class="card">
                        <div class ="overlay2">
                            <img class="card-img-top" src="card9.jpg" alt="Card image cap">
                        </div>
                    </div>
                    <div class="card">
                        <div class ="overlay2">
                            <img class="card-img-top" src="card10.jpg" alt="Card image cap">
                        </div>
                    </div>
                </div>
            </div>
          ...
          <div class="col-sm-1" style="background-color:#ffff;"></div>
            <div class="col-sm-8" style="background-color:rgb(255, 255, 255);">
                <div class="card-deck">
                    <div class="card">
                        <div class ="overlay2">
                            <img class="card-img-top" src="card11.jpg" alt="Card image cap">
                        </div>
                    </div>
                    <div class="card">
                        <div class ="overlay2">
                            <img class="card-img-top" src="card12.jpg" alt="Card image cap">
                        </div>
                    </div>
                    <div class="card">
                        <div class ="overlay2">
                            <div class="text-center">
                                    <img class="card-img-top" src="card13.jpg" alt="Card image cap">
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        <div class ="overlay2">
                            <img class="card-img-top" src="card14.jpg" alt="Card image cap">
                        </div>
                    </div>
                    <div class="card">
                        <div class ="overlay2">
                            <img class="card-img-top" src="card15.jpg" alt="Card image cap">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
          ...
          <div class="col-sm-8" style="background-color:rgb(255, 255, 255);">
              <div class="card-deck">
                  <div class="card">
                      <img class="card-img-top" style='visibility: hidden;'' src="card1.jpg" alt="Card image cap">
                  ...
                  <div class="card">
                        <div class ="overlay2">
                            <img class="card-img-top" src="card16.jpg" alt="Card image cap">
                        </div>
                    </div>
                  <div class="card">
                      <img class="card-img-top" style='visibility: hidden;' src="card1.jpg" alt="Card image cap">
        ...
        <div class="container-fluid" id="bawah">
            ...
            <div class="row" id="rowbawah">
                ...
                <div class="col-sm-10" id="colbawah" style="background-color:#FFFFFF;">
                    <div class="text-center">
                        <img src="iconfb.png" alt="icon" class="icon">
                        <img src="icontwitter.png" alt="icon" class="icon">
                        <img src="iconig.png" alt="icon" class="icon">    
                    </div>
                </div>
                <div class="col-sm-1" style="background-color:#FFFFFF"></div>
            </div>
